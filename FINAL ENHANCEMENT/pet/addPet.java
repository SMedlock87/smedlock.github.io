...
public class addPet extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        birthdayInput.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.DateFormatter(new java.text.SimpleDateFormat("09/16/1987"))));
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        // DISPLAY PET MENU BY CLICKING BACK BUTTON
        dispose();
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        //GET USER INPUT
        String uname = nameInput.getText();  //Get pet name
        String bday = birthdayInput.getFormatterFactory().toString();  //get pet birthday
        Object gen = gender.getSelectedItem();   //is pet male or female?
        String type = typeInput.getText();    //get pet type
        String color = colorInput.getText();  // get pet color
        String breed = breedInput.getText();  //pet breed
        String weight = weightInput.getText();  // enter pet weight
            ...
            try (Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/petdb", "smedlock", "8716" )) {
                ...
                String query ="INSERT INTO petinfo"         //query to insert pet info into petdb database
                        + "(`name`, `birthday`, `gender`, `type`,`color`, `breed`, `weight`)" 
                        +
                         "VALUES('"+uname+"','"+bday+"','"+gen+"','"+type+"','"+color+"', '"+breed+"', '"+weight+"')";
                
                int x = sta.executeUpdate(query); //execute query
                if (x == 0)     //if pet exists display message
                    JOptionPane.showMessageDialog(submitButton, "Pet Already Exists!");
                    
                else {
                    JOptionPane.showMessageDialog(submitButton, "Pet ADDED!"); //otherwise add pet to db
